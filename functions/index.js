...
const ANALYSIS_SCHEMA = {
  ...
  properties: {
    ...
    verdict: { type: 'string', maxLength: 260, description: 'Verdict de la séance en 2 phrases courtes maximum (260 caractères au total) : calibrage global, ce que dit la note de l\'athlète confrontée aux chiffres, signal de fatigue ou de douleur s\'il y en a. Conclusion finale uniquement, jamais de raisonnement à voix haute ni de correction en cours de phrase.' },
